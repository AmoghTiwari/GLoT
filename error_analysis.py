...
if __name__ == "__main__":
    ...
    plot_all_errors(mpjpe_data, f"output/error_arrays/{target_dataset}_mpjpe_bar_plot.png")
    plot_all_errors(pampjpe_data, f"output/error_arrays/{target_dataset}_pampjpe_bar_plot.png")
    plot_all_errors(acc_err_data, f"output/error_arrays/{target_dataset}_acc_err_bar_plot.png")
    if target_dataset == "3dpw":
